      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Error loggin out! Please, try again.');
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"updateUserData.js":[function(require,module,exports) {
"use strict";
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'data' ? '/api/v1/users/update-me' : '/api/v1/users/update-password';
            _context.next = 4;
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type[0].toUpperCase() + type.substr(1), " updated successfully"));
              window.setTimeout(function () {
                location.reload();
              }, 1500);
            }
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGF2aXNkZXYiLCJhIjoiY2tkZm51MXo3MmlyZjJ5czg1Y3d5M2hkMyJ9.ujYxC-ZwDhSbWiRBhLY5Cg';
  ...
  locations.forEach(function (location) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(location.coordinates).addTo(map); // App popup

    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(location.coordinates).setHTML("<p>Day ".concat(location.day, ": ").concat(location.description, "</p>")).addTo(map); // Extends map bounds to include the current location
...
if (Stripe) {
  stripe = Stripe('pk_test_51HEqsnExaZxctD1wW0koeI1sUT1FaZMaBigYs2FZOjMD5tTDIrUf94ORRfw7PI7oXLexPM6qYmtsPXh4XrzHgXbN00nNqpFjwt');
}
...
var bookTourButton = document.getElementById('book-tour'); // DELEGATION
...
if (formData) {
  formData.addEventListener('submit', function (e) {
    e.preventDefault(); // Creating form data programatically

    var form = new FormData();
    form.append('name', document.getElementById('name').value);
    form.append('email', document.getElementById('email').value);
    form.append('photo', document.getElementById('photo').files[0]);
    (0, _updateUserData.updateSettings)(form, 'data');
  });
}
